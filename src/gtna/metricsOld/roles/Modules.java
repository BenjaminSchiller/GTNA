...
public class Modules {
	...
	// Graph graph = new ReadableFile("ROLE", filename, type, null,
	// null).generate();
	// // create bfs object
	// bfs = new BFS();
	//
	...
	//
	// int totallinks = (graph.edges - this.deletedLoops -
	// this.deletedParallelEdges) * 2;
	// int dice;
	...
	// inold = GeneralGraphMethods.NLinksToGroup(dice, glist[oldg], graph,
	// nlist); // number
	// // of
	// // links
	// // from
	...
	// // old
	// // group
	// innew = GeneralGraphMethods.NLinksToGroup(dice, glist[newg], graph,
	// nlist); // number
	// // of
	// // links
	// // from
	...
	//
	// // Find a reasonable split
	// private ArrayList<Integer> SAGroupSplit(Group group, double Ti, double
	// Tf,
	...
	// private int NLinksToGroupInLinks(int node, Group group, Graph g, int[]
	// nlist) {
	// int counter = 0;
	//
