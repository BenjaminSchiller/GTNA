...
/**
 * a weighted depth first search marking edges that does only allow an decline up to a certain (absolute) threshold
 * @author stefanie
 *
 */
public class DistRestrictEdgeGreedy extends EdgeGreedy {
	...
	public DistRestrictEdgeGreedy(double maxBack, int ttl){
		super(ttl,"DIST_RESTRICT_EDGE_GREEDY", new String[]{"TTL", "MAXBACK"}, new String[]{""+ttl, ""+maxBack});
