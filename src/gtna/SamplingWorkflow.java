...
public class SamplingWorkflow {
     ...
     * @param metrics
     */
    private static void loadNetworksAndCalculateMetrics(String folder, Collection<String> graphPaths, Metric[] metrics) {
	...
	// persisted graph
	calculateNetworkMetricsAndWriteToFile(false, 1, metrics,
		sampledNets, "example");
    }
