 ...
 *
 */
public class Kleinberg1D extends NetworkImpl {
	...
	private int LONG_RANGE_CONTACTS;
	 ...
	 boolean BIDIRECTIONAL, boolean RANDOM, RoutingAlgorithm ra, Transformation[] t) {
	 super("KLEINBERG_1D", nodes,
	 new String[] { "SHORT_RANGE_CONTACTS", "LONG_RANGE_CONTACTS",
	 "CLUSTERING_EXPONENT", "BIDIRECTIONAL", "RANDOM" }, new String[] {
	 "" + SHORT_RANGE_CONTACTS, "" + LONG_RANGE_CONTACTS,
	 "" + CLUSTERING_EXPONENT, "" + BIDIRECTIONAL, "" + RANDOM }, ra, t);
