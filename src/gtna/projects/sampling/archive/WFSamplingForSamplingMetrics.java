...
public class WFSamplingForSamplingMetrics {
	...
	private static boolean withNeigborSet = false;
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println("dst:" + targetdir);
		...
		ReadableFolder rf = new ReadableFolder(net.name() + "-" + samplingAlgorithm.name(),
...
//							+ "_" + si);
					...
					if (plotting)
						plotGraph(gi, targetdir + j + "/" + "plots/",
								net.name()+"-"+samplingAlgorithm.name() + "_" + si);
					
					gi = null;
				}
				writeOriginalGraphWithPropertiesToFile(g, targetdir + j
						+ "/original-with-props/", net.name()+"-"+samplingAlgorithm.name());
				if (plotting)
