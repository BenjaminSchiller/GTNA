...
public class GDAEvaluation_CC {
	public static void main(String[] args) {
		...
		Config.overwrite("MAIN_DATA_FOLDER", "./data/GDAevaluation_CC/");
		Config.overwrite("MAIN_PLOT_FOLDER", "./plots/testsNico_CC/");
