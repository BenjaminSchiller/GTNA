 ...
 * 
 */
public class GDAEvaluation_DD {
	public static void main(String[] args) {
		int lengthOfSeries = 100;
		ArrayList<Network> networks = new ArrayList<Network>();

		Transformation[] stArray = new Transformation[] { new Bidirectional(), new WeakConnectivityPartition(),
...
//		 null, stArray));
		networks.add(new DescriptionWrapper(new BarabasiAlbert(1000, 10, null, stArray), "Barabasi-Albert"));
...
//		networks.add(new ErdosRenyi(10000, 10, true, null, stArray));
		...
		Config.overwrite("MAIN_DATA_FOLDER", "./data/GDAevaluation_DD/");
		Config.overwrite("MAIN_PLOT_FOLDER", "./plots/testsNico_DD_a/");
