...
public class Test {
	...
	private static final double xyAll = 20000;
	private static final double xyHotspots = 5000;
	private static final double devHotspots = 0;
	private static final double xyNodes = 2000;
	private static final double devNodes = 0;
	...
	public static Network nwCC(int nodes, Transformation[] t) {
		PlacementModel p1 = new CommunityPlacementModel(xyHotspots, xyHotspots,
				1.0, false);
		PlacementModel p2 = new CommunityPlacementModel(xyNodes, xyNodes, 1.0,
				false);
