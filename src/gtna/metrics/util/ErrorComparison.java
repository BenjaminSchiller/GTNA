...
public class ErrorComparison extends Metric {
	...
	private ArrayList<NodeValueList> nodevaluelists = new ArrayList<NodeValueList>();
	...
	public void computeData(Graph g, Network n, HashMap<String, Metric> m) {
		...
		nodevaluelists = new ArrayList<NodeValueList>();
	...
	private NodeValueList[] compareNodeValueList(NodeValueList base, NodeValueList changed){
	...
	private Distribution[] compareDistribution(Distribution bD, Distribution cD) {
		...
		double[] comparedValues = new double[range];
		double[] absoluteValues = new double[range];
		...
		for (int i = 0; i < range; i++) {
			...
			comparedValues[i] = b - c;
			absoluteValues[i] = Math.abs(b-c);
		}
	...
	public boolean writeData(String folder) {
		...
		for (Distribution d : distributions) {
			...
			success &= DataWriter.writeWithIndex(d.getDistribution(), distrKey,
					folder);
