...
public class DisjunctPaths extends TrustMetric {
	 ...
	 * @param parameters
	 */
	public DisjunctPaths(int sampleSize, int maxPathLength, int minPaths) {
		super("DP", sampleSize, new Parameter[] {new IntParameter("K", maxPathLength), new IntParameter("L", minPaths) });
