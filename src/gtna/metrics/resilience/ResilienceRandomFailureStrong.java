 ...
 *
 * ---------------------------------------
 * ResilienceRandomFailureStrong.java
 * ---------------------------------------
 * (C) Copyright 2009-2011, by Benjamin Schiller (P2P, TU Darmstadt)
 * and Contributors 
 *
 ...
 *
 */
public class ResilienceRandomFailureStrong extends ResilienceNodeFailureStrong {

	
	public ResilienceRandomFailureStrong() {
		super("RESILIENCE_RANDOM_FAILURE_STRONG");
