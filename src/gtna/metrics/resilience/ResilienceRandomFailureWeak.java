 ...
 *
 * ---------------------------------------
 * ResilienceRandomFailureWeak.java
 * ---------------------------------------
 * (C) Copyright 2009-2011, by Benjamin Schiller (P2P, TU Darmstadt)
 * and Contributors 
 *
 ...
 * in terms of weak connectivity
 * @author stef
 *
 */
public class ResilienceRandomFailureWeak extends ResilienceNodeFailureWeak {

	public ResilienceRandomFailureWeak() {
		super("RESILIENCE_RANDOM_FAILURE_WEAK");
	...
	protected void initFailure(int nr) {
		this.failure = new RandomFailure(nr);
