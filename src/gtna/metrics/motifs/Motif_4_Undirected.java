...
public class Motif_4_Undirected extends MetricImpl implements Metric {
	...
	private Integer getMotifUndirected(int[] degree, ArrayList<Integer> nodeList) {
		int degree1 = 0;
		int degree2 = 0;
		int degree3 = 0;
...
//		 find the appropriate degree combination / motif
	...
	public boolean writeData(String folder) {
		try {
			...
			for (int i = 0; i < motif4Total.length; i++) {
				motif4Total[i] = (double) ((double) motif4Total[i] / ((double) numberOfTotalMotifs / (double) 100));
			}
