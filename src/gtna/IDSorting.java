...
import gtna.metrics.IDSpaceDistances;
import gtna.networks.Network;
import gtna.networks.model.Kleinberg1D;
...
public class IDSorting {
	private static final String SPI_INPUT_GRAPH = "./resources/SPI-3-LCC/2010-08.spi.txt";
	...
	private static final String WOT_INPUT_GRAPH = "./resources/WOT-1-BD/2005-02-25.wot.txt";
	...
	public static void execute(String LMC_M, double D, int ATT, int INDEX) {
		...
		if (PRINT_TABLES) {
			...
			String[][] successorDistancePercentage = new String[t.length][t[0].length];
	...
	private static void printTable(String[][] v, String label, String caption,
			String AS) {
		System.out.println("\n");
	...
	public static void idSpace() {
		...
		if (true) {
			...
			String filename = "/Users/benni/TUD/GTNA/data/spi-embedding/_G/LMC/0.txt";
