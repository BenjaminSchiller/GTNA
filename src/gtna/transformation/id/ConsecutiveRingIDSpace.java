 ...
 * 
 */
public class ConsecutiveRingIDSpace extends Transformation {

	private boolean wrapAround;

	public ConsecutiveRingIDSpace(boolean wrapAround) {
		super("CONSECUTIVE_RING_ID_SPACE", new Parameter[] { new BooleanParameter(
