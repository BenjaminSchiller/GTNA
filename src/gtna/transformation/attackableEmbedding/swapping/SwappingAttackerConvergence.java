...
public class SwappingAttackerConvergence extends SwappingNode {
	 ...
	 public SwappingAttackerConvergence(int index, Graph g, Swapping
	 swapping) {
	 ...
	 */
	 ...
	 ((SwappingNode) this.swapping.getRandomNeighbor(this.getGraph(),this.getIncomingEdges(), rand)).
	  swap(id, neighbors, ttl, rand);
	 }
