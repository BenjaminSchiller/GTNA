 ...
 *
 * ---------------------------------------
 * SwappingWCAttackerKleinberg.java
 * ---------------------------------------
 * (C) Copyright 2009-2011, by Benjamin Schiller (P2P, TU Darmstadt)
 * and Contributors 
 *
 ...
 * 
 */
public class SwappingWCAttackerKleinberg extends SwappingWCNode {

	public SwappingWCAttackerKleinberg(int index, double pos, Swapping swapping) {
		super(index, pos, swapping);
	}

	public void turn(Random rand) {
		// TODO implement
		System.out.println("performing turn @ SwappingWCAttackerKleinberg "
				+ this.toString());
	}
