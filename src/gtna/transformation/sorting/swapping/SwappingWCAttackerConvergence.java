 ...
 *
 * ---------------------------------------
 * SwappingAttackerWCConvergence.java
 * ---------------------------------------
 * (C) Copyright 2009-2011, by Benjamin Schiller (P2P, TU Darmstadt)
 * and Contributors 
 *
 ...
 * 
 */
public class SwappingWCAttackerConvergence extends SwappingWCNode {

	public SwappingWCAttackerConvergence(int index, double pos,
			Swapping swapping) {
	...
	public void turn(Random rand) {
		// TODO implement
		System.out.println("performing turn @ SwappingWCAttackerConvergence "
				+ this.toString());
	}
